 ...
 * @author  Niklaus Höpfner <editor@nik-web.net>
 */
class MetaNavFactoryTest extends TestCase
{
    /**
     * @var MetaNavFactory
     */
    ...
    {
        $this->factory = new MetaNavFactory();
     ...
     * @return void
     */
    public function testMetaNavFactoryReturnsObjectInstance() : void
    {
        $factory = $this->factory;
        //$this->assertInstanceOf(MetaNavFactory::class, $factory);
